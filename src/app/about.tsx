    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          ...
          The neural network model is stored on the device and executes using the device&apos;s
          CPU/GPU, keeping your data private and enabling offline use.
        </Text>
        ...
        <Text style={styles.paragraph}>
          We use SSDLite with MobileNetV3 Large—a model designed for mobile and edge devices. It is
          small (~14 MB), fast (~100–280 ms per image on modern phones), and runs efficiently
          without specialized hardware. Heavier models would be too slow or require cloud inference,
          which would defeat the purpose of on-device, real-time detection.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
